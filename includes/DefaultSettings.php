...
$wgFooterIcons = array(
	...
	"poweredby" => array(
		...
		"TeleTaleem" => array(
				"src" => null, //"$wgStylePath/common/images/teletaleem.png",
				"url" => "http://www.teletaleem.com/",
				"alt" => "Powered by TeleTaleem",
		),
		"AUS" => array(
				"src" => null,//"$wgStylePath/common/images/AUS_logo.png",
 ...
 */
$wgRestrictionTypes = array( 'create', 'edit', 'move', 'upload','bulkcreate');
