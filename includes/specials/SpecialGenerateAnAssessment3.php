...
global $wgOut,$IP,$wgUser,$wgRequest;
   ...
   //$fh = fopen($myFile, 'w') or die("can't open file");   
	...
	$db_result = $db->query( "CREATE TEMPORARY TABLE tmp as (select distinct b.rev_page,b.rev_user_text as user,
							  REPLACE(a.page_title,'_',' ') as page_title FROM page a, revision b, Marker_1 d where
							  a.page_id=b.rev_page and a.page_id=d.page_id and b.rev_timestamp in(select MIN(rev_timestamp)as rev_timestamp FROM revision c WHERE c.rev_page=b.rev_page) and
