...
class LoginForm extends SpecialPage {
	...
	var $mLoginattempt, $mRemember, $mEmail,$mMobile, $mDomain, $mLanguage;
	...
	function load( $request ) {
		...
		$this->mMobile= $request->getText( 'wpMobile' );
	...
	function mainLoginForm( $msg, $msgtype = 'error' ) {
		...
		$template->set( 'mobile', $this->mMobile );
