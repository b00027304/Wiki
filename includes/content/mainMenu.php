...
<h2>Main menu</h2>
<dl>
	<dt><a href="<?php echo strtok(SITEROOT_WEB,'\/').'.php'; ?>?page=newAssessmentItem">New assessment item</a></dt>
	<dd>Write a new assessment item</dd>

	<dt><a href="<?php echo strtok(SITEROOT_WEB,'\/').'.php'; ?>?page=uploadAssessmentItem">Upload an existing assessment item</a></dt>
