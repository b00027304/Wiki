...
if ( isset( $wgFooterIcons['poweredby'] ) &&
	...
	$wgFooterIcons['poweredby']['TeleTaleem']['src'] === null &&
	$wgFooterIcons['poweredby']['AUS']['src'] === null)
{
	$wgFooterIcons['poweredby']['mediawiki']['src'] = "$wgStylePath/common/images/poweredby_mediawiki_88x31.png";
	$wgFooterIcons['poweredby']['TeleTaleem']['src'] = "$wgStylePath/common/images/teletaleem.png";
	$wgFooterIcons['poweredby']['AUS']['src'] = "$wgStylePath/common/images/AUS_logo.png";
}
