...
abstract class QTIMultipleChoiceResponse extends QTIAssessmentItem {
	...
	public function formHTML() {
		...
		<dd><textarea rows="2" cols="20" name="prompt" id="prompt"><?php if (isset($this->data["prompt"])) echo htmlspecialchars($this->data["prompt"]); ?></textarea></dd>
				...
				<table style="width: 100%;">
					...
					<?php for ($i = 0; array_key_exists("option_{$i}_optiontext", $this->data); $i++) { $odd = $i % 2; ?>
						<tr class="feedback row<?php echo $odd; ?>" id="option_<?php echo $i; ?>_feedback">
							...
							<td><textarea style="width: 100%;" class="qtitinymce feedbackchosen" rows="2" cols="20" name="option_<?php echo $i; ?>_feedback_chosen" id="option_<?php echo $i; ?>_feedback_chosen"><?php if (isset($this->data["option_{$i}_feedback_chosen"])) echo htmlspecialchars($this->data["option_{$i}_feedback_chosen"]); ?></textarea></td>
							<td><textarea style="width: 100%;" class="qtitinymce feedbackunchosen" rows="2" cols="20" name="option_<?php echo $i; ?>_feedback_unchosen" id="option_<?php echo $i; ?>_feedback_unchosen"><?php if (isset($this->data["option_{$i}_feedback_unchosen"])) echo htmlspecialchars($this->data["option_{$i}_feedback_unchosen"]); ?></textarea></td>
						</tr>
					<?php } ?>
				</table>
			</div>
