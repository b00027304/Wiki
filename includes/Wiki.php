...
class MediaWiki {
	...
	private function performAction( Page $article ) {
		global $wgSquidMaxage, $wgUseExternalEditor,$wgRequest;
		...
		switch( $act ) {
			...
			case 'GenerateAssessment':
				$Assessment = new SpecialGenerateAnAssessment();
				$Assessment->Generate_An_Assessment($wgRequest);
				break;
				
			case 'DownloadQuestions':
				  $Questions = new SpecialDownloadQuestions();
				  $Questions->DownloadQuestions($wgRequest);
				  break;
		
		    case 'CreatBulkCategories':
					$BulkCats = new SpecialCreatBulkCategories();
					$BulkCats->Create_Cat_Pages($wgRequest);
					break;
			case 'view':
