...
Inappropriate files will be deleted immediately, see the [[{{MediaWiki:Multipleupload-page}}|file deletion policy]].",
	...
	'multiupload-CatUpload' => 'Upload Learning Outcome',
...
$messages['bg'] = array(
	...
	'multipleupload-text' => "Тази страница позволява качването на няколко файла.

Изберете 'Browse' и изберете всеки от файловете, които желаете да качите.
Можете да качите от 1 до $1 файла едновременно.

Можете да въведете незадължително '''Целево име на файла''' и да предоставите описателно '''Резюме''' на всеки файл.
...
$messages['el'] = array(
	...
	'multipleupload-text' => "Επιφορτώστε πολλαπλά αρχεία εδώ.

Επιλέξτε 'Πλοήγηση' και επιλέξτε κάθε αρχείο που επιθυμείτε να επιφορτώσετε.
Μπορείτε να επιφορτώσετε από 1 έως $1 αρχεία κάθε φορά.

Μπορείτε να εισάγετε ένα προαιρετικό '''όνομα-προορισμό''' και να παρέχετε μια '''Περίληψη''' που να περιγράφει το αρχείο σας.

Ακατάλληλα αρχεία θα διαγράφονται αμέσως. Δείτε και την [[{{MediaWiki:Multipleupload-page}}|πολιτική διαγραφής αρχείων]].",
...
សូមជ្រើសរើស 'Browse' និងជ្រើសរើសឯកសារនីមួយៗដែលអ្នកចង់ផ្ទុកឡើង។

អ្នកអ្នកផ្ទុកឡើងនូវឯកសារពី១ដល់$1ឯកសារក្នុងពេលតែមួយ។
...
$messages['mk'] = array(
	...
	'multipleupload-text' => "Тука подигнете повеќе податотеки наеднаш.

Одберете „Прелистај“ и изберете ги сите податотеки што сакате да ги подигнете.
Можете да подигате од 1 до $1 податотеки наеднаш.

Можете да внесете и незадолжително '''Целно име на податотеката''' и да внесете '''Опис''' на податотеката.

Несоодветните податотеки ќе бидат веднаш избришани; погледајте ги [[{{MediaWiki:Multipleupload-page}}|правилата за бришење на податотеки]].",
	'multiupload-fileuploaded' => 'Податотеката е подигната.',
	'multiupload-toolbox' => 'Подигнете повеќе податотеки',
	'multiupload-no-files' => 'Одберете барем една податотека за подигање',
...
$messages['tg-cyrl'] = array(
	...
	'multipleupload-text' => "Парвандҳои чандгонаро боргузорӣ кунед.

Тугмаи 'Мурур'-ро пахш кунед ва ҳар парвандаеро интихоб кунед, ки шумо мехоҳед боргузорӣ кунед.
Шумо дар як вақт аз 1 то $1 парвандаҳоро метавонед боргузорӣ кунед.

Шумо метавонед ихтиёрӣ '''Номи парвандаи мақсад''' ва '''Хулоса''' бо тавсифи кардани парвандаи худ ворид кунед.
