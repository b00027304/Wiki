...
return array(
	...
	'mediawiki.action.edit' => array(
		...
		'mediawiki.action.edit.normal' => array(
				'scripts' => 'resources/mediawiki.action/mediawiki.action.edit.normal.js',
				'dependencies' => array(
						'jquery.textSelection',
						'jquery.byteLimit',
				),
	...
	'Extended_Matching_Item_JS_Header' => array(
		'scripts' => 'resources/Qti/Extended_Matching_Item_JS_Header.js',
		),
		
	'Multiple_Choice_JS_header' => array(
				'scripts' => 'resources/Qti/Multiple_Choice_JS_header.js',
		),
		
	'Question_Matrix_JS_Header' => array(
				'scripts' => 'resources/Qti/Question_Matrix_JS_Header.js',
		),
		
	'Text_Entry_JS_Header' => array(
				'scripts' => 'resources/Qti/Text_Entry_JS_Header.js',
		),
		
	'jquery.scrollTo-1.4.2-min' => array(
				'scripts' => 'includes/include/jquery.scrollTo-1.4.2-min.js',
		),
		
	'jquery.tinymce' => array(
				'scripts' => 'includes/include/tiny_mce/jquery.tinymce.js',
		),
		
	'eqiat' => array(
				'scripts' => 'includes/include/eqiat.js',
		),
		
	'MoveLO' => array(
				'scripts' => 'resources/Qti/MoveLO.js',
		),
		
	'Cat_List' => array(
				'scripts' => 'resources/Qti/Cat_List.js',
		),
