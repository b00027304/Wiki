...
<?php
	...
	protected function renderPortals( $sidebar ) {
		...
		if ( !isset( $sidebar['ADDINGQUESTION'] ) ) $sidebar['ADDINGQUESTION'] = true;
...
?>
	<div id="p-AddingQuestion" class="portlet">
		<h5><label for="AddQuestionInput"> Adding A Question </label></h5>
		<div id="AddQBody" class="pBody">
			<form action="<?php $this->text('wgScript') ?>" id="AddQuestionform">
				<input type='hidden' name="title" value="Special:AddQuestion"/>
					
			    <h5><label> Choose A Category: </label></h5>	
				
				<?php echo $this->addCategorylist(); ?>
			    <?php echo $this->makeAddQButton(array( "id" => "mw-AddQButton", "title" => "Add a Question" ));?>
...
global $wgRequest;
		...
		//$droplist="<FONT SIZE=\"1\"> ";
		$droplist=" <select name=\"CategoryList\" STYLE=\"font-size : 8pt\" id=\"mw_Catlist\" >";
